...
# Session 11 student scaffold.
# Use this existing robot system strictly as a reference for the Smart Warehouse brief.
# Students run it, observe it, and connect what they see to the worksheet.
...
print("Session 11 reference system")
print("Run the program and observe the existing robot system.")
print("Worksheet prompts:")
print("- What can the existing robot already do?")
print("- Which Smart Warehouse job could this capability support?")
print("- What limitation does the existing system have?")
print("- Which components or code could potentially be reused?")
print("- What measurable success criterion could be derived from the observed behaviour?\n")
...
try:
    while True:
        ...
        cv2.putText(
            frame,
            "Investigate: camera -> vision -> decision -> serial -> robot",
            (20, frame.shape[0] - 20),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.55,
            (255, 255, 255),
        ...
        cv2.imshow("session11_student_reference", frame)
